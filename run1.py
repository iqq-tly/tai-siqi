...
class PI_DeepONet(nn.Module):
    ...
    def train(self,u1,u2,u_s1, u_s2,dataloader1,dataloader2):
        ...
        self.optimizer = torch.optim.LBFGS(params, lr=0.006,history_size=10, line_search_fn="strong_wolfe",
...
model4 = KAN([200,2,2,2,2,2,2], base_activation=nn.Identity)
model5 = KAN([2,2,2,2,2,2,2], base_activation=nn.Identity)
