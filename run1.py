...
class PI_DeepONet(nn.Module):
    ...
    def train(self,u1,u2,u3,dataloader1,dataloader2):
        ...
        self.optimizer = torch.optim.LBFGS(params, lr=0.0001,history_size=20, line_search_fn="strong_wolfe",
...
model3 = KAN([3,2,2,1], base_activation=nn.Identity)
model4 = KAN([100,2,2,2], base_activation=nn.Identity)
model5 = KAN([2,2,2,2], base_activation=nn.Identity)
